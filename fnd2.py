...
# Example: Make predictions using the CNN model
y_pred_cnn = best_cnn_model.predict(X_padded)
predicted_label_cnn = "Fake" if y_pred_cnn > 0.5 else "True"
